...
public class CadastrarPokemons extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtPesoPokemon = findViewById(R.id.editTextPesoCadPokemon);
        edtTipoPokemon = findViewById(R.id.editTextTipoCadPokemon);
        edtEspeciePokemon = findViewById(R.id.editTextPesoCadPokemon);
        edtHabilidadePokemon = findViewById(R.id.editTextPesoCadPokemon);
    ...
    public void cadastrarPokemon(View view){
        ...
        try{
            ...
            pokemon.setPeso(Integer.parseInt(edtPesoPokemon.getText().toString()));
